...
#if !AveCheckSdkCompileVersion( 0, 8, 2, 0 ) && !AveCheckSdkCompileVersionPrivate( 2022, 416 ) && ( 0 != __AveVersion_Major || 0 != __AveVersion_Minor || 0 != __AveVersion_Build || 0 != __AveVersion_Private )
