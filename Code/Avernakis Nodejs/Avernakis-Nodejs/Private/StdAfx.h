...
#if !AveCheckSdkCompileVersion( 0, 8, 2, 0 ) && !AveCheckSdkCompileVersionPrivate( 2022, 411 )
#	error This node addon needs Ave SDK 0.8.2 or private version 2022.411 at least.
#endif
