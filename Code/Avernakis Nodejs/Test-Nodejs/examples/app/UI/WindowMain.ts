...
export class WindowMain implements IWindowMain {
    ...
    private CreateUIMain(sender: Window) {
        ...
        const statusbar = grid0
            .ControlAdd(new StatusBar(sender))
            .SetGrid(0, 1)
            .GetControl();
        statusbar.SetPart([
        ...
        const grid = grid0
            .ControlAdd(new Grid(sender))
            .SetGrid(0, 0)
            .GetControl();
        grid.ColAddDpx(200)
            .ColAddSlice(1)
            .RowAddSlice(1)
            .SetSplitterX(DpiSize.FromPixelScaled(6));

        const lstPage = grid
            .ControlAdd(new RichListBox(sender))
            .SetGrid(0, 0)
            .GetControl();
        ...
        this.m_Page.sort((x, y) =>
            DefaultString[x.NameKey] < DefaultString[y.NameKey] ? -1 : 1
        );
    ...
    private CreateUIRibbonButton(
        ...
        btn.SetSmallVisual(
            this.WindowObject.CreateManagedIcon(new IconSource(nIcon, 16))
        );
        btn.SetSmall(bSmall);
        if (!bSmall)
            btn.SetBigVisual(
                this.WindowObject.CreateManagedIcon(new IconSource(nIcon, 32))
            );
        return btn;
    }
    ...
    private CreateUIRibbon(sender: Window) {
        ...
        const pHomeEditPaste = this.CreateUIRibbonButton(
            "RibHomeClipPaste",
            ResId.Icon_Paste_png
        );
        pHomeEditPaste.SetButtonType(ButtonType.Split);
        pHomeClip.ControlAdd(pHomeEditPaste);

        const pHomeEditCut = this.CreateUIRibbonButton(
            "RibHomeClipCut",
            ResId.Icon_Cut_png,
            true
        );
        ...
        const pHomeEditCopy = this.CreateUIRibbonButton(
            "RibHomeClipCopy",
            ResId.Icon_Copy_png,
            true
        );
        ...
        const pHomeEditDelete = this.CreateUIRibbonButton(
            "RibHomeClipDelete",
            ResId.Icon_Delete_png,
            true
        );
        ...
        pHomeSel.ControlAdd(
            this.CreateUIRibbonButton("RibHomeSelSel", ResId.Icon_Paste_png)
        );
        pHomeSel.ControlAdd(
            this.CreateUIRibbonButton("RibHomeSelMove", ResId.Icon_Cut_png)
        );
        pHomeSel.ControlAdd(
            this.CreateUIRibbonButton("RibHomeSelScale", ResId.Icon_Copy_png)
        );
        pHomeSel.ControlAdd(
            this.CreateUIRibbonButton("RibHomeSelRot", ResId.Icon_Delete_png)
        );
        ...
        pHomeFontToolbar.ToolInsert(
            new ToolBarItem(
                1,
                ToolBarItemType.Button,
                sender.CacheIcon(new IconSource(ResId.Icon_File_png, 16))
            ),
            -1
        );
        pHomeFontToolbar.ToolInsert(
            new ToolBarItem(
                2,
                ToolBarItemType.Button,
                sender.CacheIcon(new IconSource(ResId.Icon_FileOpen_png, 16))
            ),
            -1
        );
        pHomeFontToolbar.ToolInsert(
            new ToolBarItem(
                3,
                ToolBarItemType.Button,
                sender.CacheIcon(new IconSource(ResId.Icon_FileSave_png, 16))
            ),
            -1
        );
        pHomeFontToolbar.ToolInsert(
            new ToolBarItem(
                4,
                ToolBarItemType.Button,
                sender.CacheIcon(new IconSource(ResId.Icon_FileSaveAs_png, 16))
            ),
            -1
        );
        pHomeFontToolbar.ToolInsert(
            new ToolBarItem(
                5,
                ToolBarItemType.Button,
                sender.CacheIcon(new IconSource(ResId.Icon_Cut_png, 16))
            ),
            -1
        );
        pHomeFontToolbar.ToolInsert(
            new ToolBarItem(
                6,
                ToolBarItemType.Button,
                sender.CacheIcon(new IconSource(ResId.Icon_Copy_png, 16))
            ),
            -1
        );
        pHomeFontToolbar.ToolInsert(
            new ToolBarItem(
                7,
                ToolBarItemType.Button,
                sender.CacheIcon(new IconSource(ResId.Icon_Paste_png, 16))
            ),
            -1
        );
        ...
        for (let i = 0; i < 32; ++i) {
            galitem.Icon = sender.CacheIcon(
                new IconSource(
                    Math.floor(
                        (ResId.$AppRes_Icon_Min >> 4) +
                            (ResId.$AppRes_Icon_Max >> 4) * Math.random()
                    ) << 4,
                    24
                )
            );
        ...
        pCreateBasic.ControlAdd(
            this.CreateUIRibbonButton(
                "RibCreateBasicPlane",
                ResId.Icon_Paste_png
            )
        );
        pCreateBasic.ControlAdd(
            this.CreateUIRibbonButton("RibCreateBasicBox", ResId.Icon_Cut_png)
        );
        pCreateBasic.ControlAdd(
            this.CreateUIRibbonButton(
                "RibCreateBasicSphere",
                ResId.Icon_Copy_png
            )
        );
        pCreateBasic.ControlAdd(
            this.CreateUIRibbonButton(
                "RibCreateBasicCylinder",
                ResId.Icon_Delete_png
            )
        );
        ...
        pCreateExt.ControlAdd(
            this.CreateUIRibbonButton("RibCreateExtSky", ResId.Icon_Paste_png)
        );
        pCreateExt.ControlAdd(
            this.CreateUIRibbonButton("RibCreateExtOcean", ResId.Icon_Cut_png)
        );
        pCreateExt.ControlAdd(
            this.CreateUIRibbonButton("RibCreateExtForest", ResId.Icon_Copy_png)
        );
    ...
    private CreateUIAppToolbar(sender: Window) {
        const tbrApp = new ToolBar(
            sender,
            new StringKey("WdMainAppbar", 0, 10)
        );
        ...
        tbrApp.ToolInsert(
            new ToolBarItem(
                2,
                ToolBarItemType.Button,
                sender.CacheIcon(new IconSource(ResId.Icon_Undo_png, 16))
            ),
            -1
        );
        tbrApp.ToolInsert(
            new ToolBarItem(
                3,
                ToolBarItemType.Button,
                sender.CacheIcon(new IconSource(ResId.Icon_Redo_png, 16))
            ),
            -1
        );
        tbrApp.ToolInsert(new ToolBarItem(0, ToolBarItemType.Splitter), -1);
        ...
        mnuFile.InsertItem(
            new MenuItem(1, MenuType.Text, 0, "", "Ctrl+N", "N")
        );
        mnuFile.InsertItem(
            new MenuItem(2, MenuType.Text, 0, "", "Ctrl+O", "O")
        );
        mnuFile.InsertItem(
            new MenuItem(
                3,
        ...
        mnuFile.InsertItem(
            new MenuItem(4, MenuType.Text, 0, "", "Ctrl+Shift+S", "A")
        );
        mnuFile.InsertItem(new MenuItem(0, MenuType.Separator));
        mnuFile.InsertItem(
            new MenuItem(5, MenuType.Text, 0, "", "Alt+F4", "X")
        );
        ...
        mnuEdit.InsertItem(
            new MenuItem(3, MenuType.Text, 0, "", "Ctrl+X", "T")
        );
        mnuEdit.InsertItem(
            new MenuItem(4, MenuType.Text, 0, "", "Ctrl+C", "C")
        );
        mnuEdit.InsertItem(
            new MenuItem(5, MenuType.Text, 0, "", "Ctrl+V", "P")
        );
        mnuEdit.InsertItem(
            new MenuItem(6, MenuType.Text, 0, "", "Delete", "D")
        );
        ...
        for (let i = 0; i < 16; ++i)
            mnuView.InsertItem(
                new MenuItem(i + 1, MenuType.Text, 0, `View Item ${i}`)
            );
        mnuView.InsertItem(new MenuItem(0, MenuType.Separator));
        const mnuViewSub = mnuView.InsertSubMenu(
            new MenuItem(100, MenuType.Text, 0, "Sub Menu")
        );
        for (let i = 0; i < 16; ++i)
            mnuViewSub.InsertItem(
                new MenuItem(200 + i, MenuType.Text, 0, `Sub Item ${i}`)
            );
        ...
        for (let i = 0; i < 100; ++i)
            mnuTool.InsertItem(
                new MenuItem(100 + i, MenuType.Text, 0, `Menu Item ${i}`)
            );
    ...
    private CreateUISubAppToolbar(sender: Window) {
        ...
        tbrApp.ToolInsert(
            new ToolBarItem(
                1,
                ToolBarItemType.ButtonDrop,
                sender.CacheIcon(new IconSource(ResId.Icon_ZoomIn_png, 16))
            ),
            -1
        );
        tbrApp.ToolInsert(
            new ToolBarItem(
                2,
                ToolBarItemType.ButtonDrop,
                sender.CacheIcon(new IconSource(ResId.Icon_Language_png, 16))
            ),
            -1
        );
        return tbrApp;
    ...
    private OnPageSelectionChange(sender: RichListBox) {
        ...
        if (nIndex >= 0 && nIndex < this.m_Page.length)
