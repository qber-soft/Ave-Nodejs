import { Button, ButtonType, Grid, IconSource, VisualTextLayout, Window } from "../../../src";
...
class PageButton extends PageHelper<PageButton> {
	...
	OnCreateControl(window: Window) {
		...
		ctl.SetVisual(window.CreateManagedIcon(new IconSource(ResId.Icon_Clock_png, 16)));
