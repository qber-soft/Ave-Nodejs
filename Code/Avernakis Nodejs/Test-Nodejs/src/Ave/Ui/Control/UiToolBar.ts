...
export class ToolBarItem {
	...
	constructor(id: number = 0, type: ToolBarItemType = ToolBarItemType.Button, icon: IconCache = 0, width: DpiSize = DpiSize.FromPixel(0), text: string = "", tooltip: string = "") {
		this.Id = id;
		this.Type = type;
		this.Icon = icon;
		this.Width = width;
...
export interface IToolBar extends IControl {
	...
	ToolHitTest(pt: Vec2, bIncludeInvisible: boolean, bIncludeDisabled: boolean): number;
