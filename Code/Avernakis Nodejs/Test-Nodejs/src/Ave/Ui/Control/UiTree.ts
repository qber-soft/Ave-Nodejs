...
export interface ITree extends IControl {
    ...
    ItemExpand(
        pItem: TreeItemHandle,
        nExpand: ExpandAction,
    ...
    OnEditBegin(
        fn: (sender: Tree, pItem: TreeItemHandle, pEidt: TreeEdit) => void
    ): Tree;
    OnEditEnd(
        fn: (sender: Tree, pItem: TreeItemHandle, pEidt: TreeEdit) => void
    ): Tree;
    OnEditFinish(
        fn: (sender: Tree, pItem: TreeItemHandle, pEidt: TreeEditFinish) => void
    ): Tree;
