...
export class HeaderItem {
	...
	constructor(nFormat?: HeaderItemFormat, text?: string, nWidth?: DpiSize, nMinWidth?: DpiSize) {
...
export interface IHeader extends Omit<IControl, "GetRect"> {
	...
	SetSort(nIndex: number, nOrder: HeaderItemSort, nDefault: HeaderItemSort): Header;
	...
	OnAdjustWidth(/**/ fn: (sender: Header, nIndex: number, bAdjusting: boolean) => void): Header;
	OnOrder(/**/ fn: (sender: Header, nNewIndex: number, nOldIndex: number) => void): Header;
