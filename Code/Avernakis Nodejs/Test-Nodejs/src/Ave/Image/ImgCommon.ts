...
export class ImageData {
	...
	private G_U16_3_U2(x, y, z) { const d = this.View.getUint32(z * this.SlicePitch + y * this.RowPitch + x * 4); return new Vec4(0x3ff & d, 0x3ff & (d >> 10), 0x3ff & (d >> 20), 0x3 & (d >> 30)); }
	...
	private G_R10G10B10A2_UNORM           /**/(x, y, z) { return this.G_U16_3_U2(x, y, z).Div(new Vec4(1023, 1023, 1023, 3)); }
	private G_R10G10B10A2_UINT            /**/(x, y, z) { return this.G_U16_3_U2(x, y, z); }
	...
	private G_R16_SINT                    /**/(x, y, z) { return new Vec4(this.View.getInt16(z * this.SlicePitch + y * this.RowPitch + x * 2) / 32768, 0, 0, 0); }
